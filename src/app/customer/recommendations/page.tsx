    ...
    <div className="space-y-8">
      <section className="rounded-[2rem] border border-border/70 bg-card/90 p-6 shadow-sm">
        <SectionHeading
          ...
          description="Recommendations now adapt to your views, wishlist intent, purchases, and genre patterns, with a lightweight concierge layer that turns the signal into direct reading routes."
        />
        <div className="mt-6 grid gap-3 sm:grid-cols-3">
          {[
            ...
            "The concierge turns that live pool into themed suggestions when you want a clearer next move.",
          ].map((copy) => (
